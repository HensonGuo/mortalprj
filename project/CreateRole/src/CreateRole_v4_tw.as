package
{
	...
	public class CreateRole_v4_tw extends BaseMovieClip
	{
		private const nameExp:RegExp = /^[A-Za-z0-9\一-\龥]+$/;//英文数字中文 
		
		public function CreateRole_v4_tw()
		{
			super();
		}
		...
		{
			_createRoleMC = new CreateRoleMC_v4_tw();
		...
		override protected function changeSelect(camp:int,sex:int):void
		{
			...
			//			{
			//				(_createRoleMC["camp_"+_camp] as MovieClip).filters = null;	
			//			}
			//			(_createRoleMC["camp_"+camp] as MovieClip).filters = [downFilter];
