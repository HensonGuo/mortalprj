...
package mortal.component.skin.combobox.comboboxSkin
{
	...
	public class ComboboxOverSkin extends Sprite
	{
		private var _scaleBg:ScaleBitmap;
		public function ComboboxOverSkin() 
		{
			createChildren();
		}
		...
		private function createChildren():void
		{
			...
			var _button:Bitmap = GlobalClass.getBitmap(ImagesConst.ComboButton_over);
