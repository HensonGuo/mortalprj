package mortal.component.skin.combobox.comboboxSkin
{
	...
	public class ComboboxSimpleUpSkin extends Sprite
	{
		private var _scaleBg:ScaleBitmap;
		public function ComboboxSimpleUpSkin()
		{
			createChildren();
		}
		...
		private function createChildren():void
		{
			...
			var _button:Bitmap = GlobalClass.getBitmap(ImagesConst.ComboButtonS_up);
