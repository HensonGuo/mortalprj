package mortal.component.skin.button
{
	...
	public class PetHeadCallbackBtnStyle extends SkinStyle
	{
		...
		public function PetHeadCallbackBtnStyle()
		{
			super();
		}
		...
		override public function setStyle(component:UIComponent):void
		{
			...
			var upSkin:GBitmap = GlobalClass.getBitmap(ImagesConst.PetHeadCallback_upSkin);
			var overSkin:GBitmap = GlobalClass.getBitmap(ImagesConst.PetHeadCallback_overSkin);
