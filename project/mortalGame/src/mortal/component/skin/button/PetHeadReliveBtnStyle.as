package mortal.component.skin.button
{
	...
	public class PetHeadReliveBtnStyle extends SkinStyle
	{
		...
		public function PetHeadReliveBtnStyle()
		{
			super();
		}
		...
		override public function setStyle(component:UIComponent):void
		{
			...
			var upSkin:GBitmap = GlobalClass.getBitmap(ImagesConst.PetHeadRelive_upSkin);
			var overSkin:GBitmap = GlobalClass.getBitmap(ImagesConst.PetHeadRelive_OverSkin);
