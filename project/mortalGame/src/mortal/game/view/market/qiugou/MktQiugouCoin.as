package mortal.game.view.market.qiugou
{
	 ...
	 * @author lizhaoning
	 */
	public class MktQiugouCoin extends MktQiugouBase
	{
		private var _txtCount:MoneyInput;
		private var _txt:GTextFiled;
		public function MktQiugouCoin()
		{
			super();
		}
		...
		//	_txtCount.textInput.textField.setTextFormat(_tfBai);
			...
			_txtTotalPrice.unit = EPrictUnit._EPriceUnitGold;
		...
		{
			var count:int = _txtCount.value*10000;
