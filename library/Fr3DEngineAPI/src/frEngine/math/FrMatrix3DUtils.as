	...
	public class FrMatrix3DUtils
	{
		...
		public static function getMaxToGameRotation():Quaternion{
			...
			if (_rotationQuat == null)
			{
				...
				_local1 = new Quaternion();
				_local2 = new Quaternion();
				_local1.fromAxisAngle(Vector3D.X_AXIS, (-(Math.PI) * 0.5));
				_local2.fromAxisAngle(Vector3D.Y_AXIS, (Math.PI * 0.5));
				_rotationQuat.multiply(_local2, _local1);
			};
		...
		public static function getMaxToGameRotation2():Quaternion{
			...
			if (_rotationQuat2 == null)
			{
				...
				_local1.fromAxisAngle(Vector3D.X_AXIS, (-(Math.PI) * 0.5));
				_local2.fromAxisAngle(Vector3D.Y_AXIS, (-(Math.PI) * 0.5));
				_rotationQuat2.multiply(_local2, _local1);
			};
		...
		public static function getMaxToGameInvMatrix():Matrix3D{
			...
			{
				_local1 = getMaxToGameRotation();
				_maxToGameInvMatrix = _local1.toMatrix3D();
		...
		public static function getMaxToGameMatrix():Matrix3D{
			...
			{
				_local1 = getMaxToGameRotation();
				_maxToGameMatrix = _local1.toMatrix3D();
				_local2 = getToLeftHandleMatrix();
				_maxToGameMatrix.append(_local2);
			};
        ...
        */
        ...
        {
        	var r1 : Vector.<Number> = FrMatrix3DUtils.RAW_DATA_CONTAINER;
