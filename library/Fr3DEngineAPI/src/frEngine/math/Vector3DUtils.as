package frEngine.math
{
	...
	public class Vector3DUtils
	{
		...
		public static function matrix2euler(m1:Matrix3D):Vector3D
        {
			...
			var raw : Vector.<Number> = FrMatrix3DUtils.RAW_DATA_CONTAINER;
		...
		public static function multyply(a:Vector3D,b:Vector3D):Vector3D
		{
		...
		public static function subdivide2(a:Vector3D,b:Vector3D):Vector3D
		{
			var v:Vector3D=new Vector3D();
			v.x=a.x/b.x;
			v.y=a.y/b.y;
		 ...
		 * 
		 */		
		public static function subtract(a:Vector3D, b:Vector3D, target:Vector3D):void
		{
			target.x = a.x - b.x;
			target.y = a.y - b.y;
			target.z = a.z - b.z;
