package  frEngine.myDebugUtils
{
	...
	public class AwayStats extends Sprite
	{
		 ...
		 * respectively.
		 */
		public function AwayStats( minimized : Boolean = false, transparent : Boolean = false, meanDataLength : uint = 0, enableClickToReset : Boolean = true, enableModifyFrameRate : Boolean = true)
		{
			super();
		...
		private function _redrawStats() : void
		{
			...
			_swhw_tf.text=String(Device3D.objectsDrawn)
