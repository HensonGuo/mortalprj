	...
	public class TweenLite extends TweenCore {
		...
		public static function initClass():void {
			...
			*/
			...
			rootTimeline30 = new SimpleTimeline(null);
			rootTimeline.cachedStartTime = getTimer() * 0.001;
			rootTimeline30.cachedStartTime = getTimer() * 0.001;
			rootFramesTimeline.cachedStartTime = rootFrame;
			rootTimeline.autoRemoveChildren = true;
			rootTimeline30.autoRemoveChildren = true;
			rootFramesTimeline.autoRemoveChildren = true;
			_time.start();
			_time.addListener(TimerType.ENTERFRAME,updateAll);
//			_shape.addEventListener(Event.ENTER_FRAME, updateAll, false, 0, true);
		...
		/**30帧数的定时器触发的*/
		public static var rootTimeline30:SimpleTimeline;
...
//		private static var _shape:Shape = new Shape();
		...
		/** @private **/
		override public function renderTime(time:Number, frameCount:int,suppressEvents:Boolean=false, force:Boolean=false):void {
...
//---- STATIC FUNCTIONS -----------------------------------------------------------------------------------
		 ...
		 */
		 protected static function updateAll(timer:FrameTimer = null):void {
			if(timer.isRepair)
			{
				return;
			}
...
//			if(rootFrame%2)
//			{
//				rootTimeline30.renderTime(((getTimer() * 0.001) - rootTimeline30.cachedStartTime) * rootTimeline30.cachedTimeScale,rootFrame, false, false);
//			}
			rootTimeline.renderTime(((getTimer() * 0.001) - rootTimeline.cachedStartTime) * rootTimeline.cachedTimeScale, rootFrame,false, false);
			rootFramesTimeline.renderTime((rootFrame - rootFramesTimeline.cachedStartTime) * rootFramesTimeline.cachedTimeScale,rootFrame, false, false);
