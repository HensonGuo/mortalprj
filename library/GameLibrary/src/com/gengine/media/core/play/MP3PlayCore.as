package com.gengine.media.core.play
{
	...
	import com.gengine.media.interfaces.IMediaPlayCore;
	...
	public class MP3PlayCore extends MediaPlayCore implements IMediaPlayCore
	{
		...
		private function soundPlayAction(position:Number = 0):void
		{
			...
			_soundChanel.addEventListener(Event.SOUND_COMPLETE, soundCompleteEventHandler);
			volume = _volume;
		}
