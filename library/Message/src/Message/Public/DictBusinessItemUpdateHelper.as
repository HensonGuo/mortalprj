...
public class DictBusinessItemUpdateHelper
{
    public static function write( __os : SerializeStream , __v : Dictionary ) : void
    {
        ...
        else
        {
            ...
            {
                __os.writeString(String( __i));
                ( __v[ __i ] as SBusinessItemUpdate).__write(__os);
            }
        }
    }
    ...
    public static function read( __is : SerializeStream ) : Dictionary
    {
        ...
        {
            var __key:String = __is.readString();
            var __value: SBusinessItemUpdate;
            __value = new SBusinessItemUpdate();
            __value.__read(__is);
            __v[__key] = __value;
        }
        return __v;
