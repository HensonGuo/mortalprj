...
public class SeqSFightAttributeAddPercentHelper
{
    public static function write( __os : SerializeStream , __v : Array ) : void 
    {
        ...
        else
        {
            ...
            {
                var __v1 : SFightAttributeAddPercent = __v[__i0] as SFightAttributeAddPercent;
                __v1.__write(__os);
            }
        }
    }
    ...
    public static function read( __is : SerializeStream ) : Array
    {
        ...
        {
            var __v1 : SFightAttributeAddPercent = new SFightAttributeAddPercent();
            __v1.__read(__is);
            __v[__i0] = __v1 ;
        }
        return __v;
