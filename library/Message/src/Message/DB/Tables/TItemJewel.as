...
public class TItemJewel
{
    ...
    public var updateExper : int;

    public var decompositionExper : int;

    public var posEquip : int;

    public var decompositionCoin : int;
