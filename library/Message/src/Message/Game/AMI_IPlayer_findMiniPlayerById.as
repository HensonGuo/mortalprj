...
public class AMI_IPlayer_findMiniPlayerById extends RMIObject
{
    public function AMI_IPlayer_findMiniPlayerById(response : Function = null , ex : Function = null , obj : Object = null )
    {
        super( response , ex );
        userObject = obj;
        callFunction = "findMiniPlayerById";
    }
