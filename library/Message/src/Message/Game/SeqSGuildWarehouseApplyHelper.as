...
public class SeqSGuildWarehouseApplyHelper
{
    public static function write( __os : SerializeStream , __v : Array ) : void 
    {
        ...
        else
        {
            ...
            {
                var __v1 : SGuildWarehouseApply = __v[__i0] as SGuildWarehouseApply;
                __v1.__write(__os);
            }
        }
    }
    ...
    public static function read( __is : SerializeStream ) : Array
    {
        ...
        {
            var __v1 : SGuildWarehouseApply = new SGuildWarehouseApply();
            __v1.__read(__is);
            __v[__i0] = __v1 ;
            __is.checkSeq();
            __is.endElement();
