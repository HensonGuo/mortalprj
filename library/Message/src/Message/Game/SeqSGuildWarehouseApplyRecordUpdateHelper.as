...
public class SeqSGuildWarehouseApplyRecordUpdateHelper
{
    public static function write( __os : SerializeStream , __v : Array ) : void 
    {
        ...
        else
        {
            ...
            {
                var __v1 : SGuildWarehouseApplyRecordUpdate = __v[__i0] as SGuildWarehouseApplyRecordUpdate;
                __v1.__write(__os);
            }
        }
    }
    ...
    public static function read( __is : SerializeStream ) : Array
    {
        ...
        {
            var __v1 : SGuildWarehouseApplyRecordUpdate = new SGuildWarehouseApplyRecordUpdate();
            __v1.__read(__is);
            __v[__i0] = __v1 ;
            __is.checkSeq();
            __is.endElement();
