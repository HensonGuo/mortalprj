...
public class SeqSGuildWarehouseRecordHelper
{
    public static function write( __os : SerializeStream , __v : Array ) : void 
    {
        ...
        else
        {
            ...
            {
                var __v1 : SGuildWarehouseRecord = __v[__i0] as SGuildWarehouseRecord;
                __v1.__write(__os);
            }
        }
    }
    ...
    public static function read( __is : SerializeStream ) : Array
    {
        ...
        __is.startSeq(__len0, 19);
        __v = new Array;
        for( var __i0 : int = 0; __i0 < __len0; __i0++)
        {
            var __v1 : SGuildWarehouseRecord = new SGuildWarehouseRecord();
            __v1.__read(__is);
            __v[__i0] = __v1 ;
            __is.checkSeq();
            __is.endElement();
