...
public class AMI_IEquip_equipRefreshReplace extends RMIObject
{
    public function AMI_IEquip_equipRefreshReplace(response : Function = null , ex : Function = null , obj : Object = null )
    {
        super( response , ex );
        userObject = obj;
        callFunction = "equipRefreshReplace";
    }
