...
public class SeqSGuildWarehouseApplyUpdateHelper
{
    public static function write( __os : SerializeStream , __v : Array ) : void 
    {
        ...
        else
        {
            ...
            {
                var __v1 : SGuildWarehouseApplyUpdate = __v[__i0] as SGuildWarehouseApplyUpdate;
                __v1.__write(__os);
            }
        }
    }
    ...
    public static function read( __is : SerializeStream ) : Array
    {
        ...
        {
            var __v1 : SGuildWarehouseApplyUpdate = new SGuildWarehouseApplyUpdate();
            __v1.__read(__is);
            __v[__i0] = __v1 ;
            __is.checkSeq();
            __is.endElement();
