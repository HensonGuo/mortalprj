...
public class AMI_IPet_upgradeTalent extends RMIObject
{
    public function AMI_IPet_upgradeTalent(response : Function = null , ex : Function = null , obj : Object = null )
    {
        super( response , ex );
        userObject = obj;
        callFunction = "upgradeTalent";
    }
