...
public class AMI_IEquip_equipQualityAdvance extends RMIObject
{
    public function AMI_IEquip_equipQualityAdvance(response : Function = null , ex : Function = null , obj : Object = null )
    {
        super( response , ex );
        userObject = obj;
        callFunction = "equipQualityAdvance";
    }
