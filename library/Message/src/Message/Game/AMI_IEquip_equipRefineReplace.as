...
public class AMI_IEquip_equipRefineReplace extends RMIObject
{
    public function AMI_IEquip_equipRefineReplace(response : Function = null , ex : Function = null , obj : Object = null )
    {
        super( response , ex );
        userObject = obj;
        callFunction = "equipRefineReplace";
    }
