...
package net.hires.debug {
	...
	public class Stats extends Sprite {
        ...
        protected const HEIGHT:uint = 130;
        ...
        protected var theme:Object = {bg: 0x000033, fps: 0xffff00, ms: 0x00ff00, mem: 0x00ffff, memmax: 0xff0070, draw3d: 0xFF9900, draw2d: 0x00AACC,triangle:0x00ff00};
        ...
        public function Stats():void {
            ...
            xml = <xml>
                ...
                <draw2d>draw2d:</draw2d>
				  <triangle>triangle:</triangle>
            </xml>;

            style = new StyleSheet();
            style.setStyle("xml", {fontSize: '10px', fontFamily: '_sans', leading: '0px'});
            ...
            style.setStyle("draw3d", {color: hex2css(theme.draw3d)});
            style.setStyle("draw2d", {color: hex2css(theme.draw2d)});
			style.setStyle("triangle", {color: hex2css(theme.triangle)});
			//style.setStyle("vertex", {color: hex2css(theme.vertex)});
        ...
        public function update(drawCalls3D:int, drawCalls2D:int,faceNum:int):void {
            timer = getTimer();
            ...
            if(timer - 1000 > ms_prev) {
                ...
                xml.draw3d = "DRAW3d: " + drawCalls3D;
				xml.draw2d = "DRAW2d: " + drawCalls2D;
                xml.triangle = "Triangle: " + faceNum;
				//xml.vertex = "Vertex: " + 0;
                fps = 0;
            }
